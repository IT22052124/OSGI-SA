...
public class LibraryAdminImpl implements LibraryAdmin {
    ...
    public void categoryMenu(String category) {
        while (true) {
            ...
            int choice = scn.nextInt(); // Get user choice
            ...
            switch (choice) {
                ...
                default:
                    System.out.println("\n Invalid choice. Try again."); // Invalid choice message
            }
    ...
    public void editResource(String category) {
        ...
        if (resource != null) {
            ...
            System.out.println("\n " + category + " not found."); // Resource not found message
        }

    }

    @Override	// Add resource
    ...
    @Override	// Search by ID
    public void searchById(String category) {
        System.out.print("Enter ID: "); // Prompt user to enter ID
        int id = scn.nextInt(); // Get ID
        scn.nextLine(); // Consume newline
        ...
        // If resource is not found or the type is not the same as the category, print
    ...
    @Override	// Search by name
    public void searchByName() {
        System.out.print("Enter Name: ");
        String name = scn.nextLine();

        // Display resources by name
